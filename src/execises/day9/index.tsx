...
const Ex = () => (
    <>
        ...
        <p></p>
        <pre>
            0   3   6   9  12  15  <em>B</em> <br/>
              3   3   3   3   3  <em>A</em> <br/>
                0   0   0   0  <em>0</em>
        </pre>
        ...
        <pre>
            0   3   6   9  12  <em>15</em>  <em>18</em> <br/>
              3   3   3   3   3  <em>3</em> <br/>
                0   0   0   0   0
        </pre>
        ...
        <pre>
            1   3   6  10  15  21  <em>28</em> <br/>
              2   3   4   5   6  <em>7</em> <br/>
                1   1   1   1  <em>1</em> <br/>
                  0   0   0  <em>0</em>
        </pre>
        ...
        <pre>
            10  13  16  21  30  45  <em>68</em> <br/>
              3   3   5   9  15  <em>23</em> <br/>
                0   2   4   6  <em>8</em> <br/>
                  2   2   2  <em>2</em> <br/>
                    0   0  <em>0</em>
        </pre>
        ...
        <p>Of course, it would be nice to have <em>even more history</em> included in your report. Surely it's safe to just <em>extrapolate backwards</em> as well, right?</p>
        ...
        <pre>
          <em>5</em>  10  13  16  21  30  45 <br />
          <em>5</em>   3   3   5   9  15 <br />
          <em>-2</em>   0   2   4   6 <br />
              <em>2</em>   2   2   2 <br />
                <em>0</em>   0   0
        </pre>
